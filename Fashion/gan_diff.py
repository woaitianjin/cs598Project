...
generator.load_weights('./models/gan_generator__epoch_%d.h5'% (50))
print(bcolors.OKBLUE + 'Model params generator loaded' + bcolors.ENDC)

discriminator.load_weights('./models/gan_discriminator_epoch_%d.h5'% (50))
...
def plotGeneratedImages(epoch, examples=100, dim=(10, 10), figsize=(16, 16)):
...
def train(epochs=1, batchSize=128):
    ...
    for e in xrange(1, epochs+1):
        ...
        print("Diffrate for this epoch: " +str(diffEpoch)+"/"+str(batchCount*batchSize) +  ' '+str(diffEpoch*0.1/(batchCount*batchSize)))
